...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2023 at 04:43 AM
...
CREATE TABLE `location` (
  ...
  `L_Picture` mediumblob DEFAULT NULL
...
CREATE TABLE `user` (
  ...
  `U_Picture` mediumblob DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(12, 'Tom ', 'Tuu', 'example@gmail.com', 'naruto777', 'naruto777password', 0x23),
(13, 'Tom ', 'Tuu', 'example@gmail.com', 'naruto777', 'naruto777password', 0x23),
(14, 'แซลมอน', 'จนเขิน', 'Salmon@gmail.com', 'Salmonjonkoen', 'salmon12345', 0x23);
...
--
ALTER TABLE `location_like`
  ADD CONSTRAINT `location_like_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  ADD CONSTRAINT `location_like_ibfk_2` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`);
...
ALTER TABLE `review`
  ...
  ADD CONSTRAINT `review_ibfk_2` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`);
COMMIT;
